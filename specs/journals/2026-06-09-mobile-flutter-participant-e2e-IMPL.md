...
- **Pending/optional:** idb-based prompt dismissal for clean screenshots; refresh the merged report by re-running all 9 with simctl; adversarial evidence audit; push commits (operator-gated).
