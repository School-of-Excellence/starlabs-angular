...
export const routes: Routes = [
  ...
  {path: 'cohort-management', loadComponent: () => import('./big/cohort-management/cohort-management.component').then(m => m.CohortManagementComponent), canActivate: [authGuard]},
