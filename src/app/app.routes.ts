...
import { TeamEvolutionDashboardComponent } from './Journey Onboarding/team-evolution-dashboard/team-evolution-dashboard.component';
...
export const routes: Routes = [
  ...
  {path: 'team-evolution-dashboard', loadComponent: () => import('./Journey Onboarding/team-evolution-dashboard/team-evolution-dashboard.component').then(m => m.TeamEvolutionDashboardComponent)},
